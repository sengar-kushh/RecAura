    ...
    <header className="sticky top-0 z-40 w-full border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-base font-semibold tracking-tight">CampusTrack</span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button asChild>
            <a href="mailto:?subject=CampusTrack%20Demo%20Request&body=Hi%20team%2C%20I%27d%20like%20a%20demo%20of%20CampusTrack.%20">Request demo</a>
          </Button>
        </div>
      </div>
    </header>
